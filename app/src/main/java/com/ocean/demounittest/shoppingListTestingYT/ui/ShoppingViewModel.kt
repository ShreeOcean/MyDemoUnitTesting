...
import com.ocean.demounittest.shoppingListTestingYT.other.Event
...
class ShoppingViewModel  @Inject constructor(private val repository: ShoppingRepository): ViewModel(){
    ...
    fun insertShoppingItem(name: String, amountString: String, priceString: String){
        ...
        if (priceString.length > Constants.MAX_PRICE_LENGTH){
            _insertShoppingItemStatus.postValue(Event(Resource.error("The price of the item must not exceed ${Constants.MAX_NAME_LENGTH} characters", null)))
            return
        }
